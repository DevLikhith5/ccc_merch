...
export function CreditCard({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ShoppingBag({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function Facebook({ size = 32 }) {
  return (
...
export function Instagram({ size = 32 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="url(#ig)" stroke="#fff" strokeWidth="0">
      <defs>
...
export function Pinterest({ size = 32 }) {
  return (
...
export function Twitter({ size = 32 }) {
  return (
